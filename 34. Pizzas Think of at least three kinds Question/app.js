...
//  Store these
// pizza names in a array, and then use a for loop to print the name
//  of each pizza.
...
let myPizza = ['Margherita', 'Pepperoni', 'Hawaiian', 'Meat', 'Lovers', 'VeggieSupreme'];
...
console.log(`\n I really like to pizza. pizza comes in a varity of floavour and tooping, allowing individuals to customize it to their liking.`);
