...
var languagues = ['Russian', 'English', 'Arabic', 'Persian', 'Hindi'];
console.log("list of different country's languages");
for (var _i = 0, languagues_1 = languagues; _i < languagues_1.length; _i++) {
    var top_1 = languagues_1[_i];
    console.log(top_1);
}
